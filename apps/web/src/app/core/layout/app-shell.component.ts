  ...
  protected readonly navigationItems = computed(() => {
    ...
    if (!user) {
      ...
      const items = [
        ...
        { label: 'Team', path: '/teams', roles: [ROLES.ADMINISTRATOR, ROLES.SERVICE_LEADER, ROLES.VOLUNTEER] },
        { label: 'Organigramma', path: '/org-chart', roles: [ROLES.ADMINISTRATOR, ROLES.SERVICE_LEADER, ROLES.VOLUNTEER] },
