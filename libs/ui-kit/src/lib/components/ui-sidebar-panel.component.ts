...
@Component({
  ...
  template: `
    <aside class="rounded-[28px] border border-[color:var(--border-soft)] bg-[color:var(--surface-1)] p-5 text-[color:var(--text-2)] shadow-[var(--shadow-soft)]" [class.h-full]="fullHeight">
